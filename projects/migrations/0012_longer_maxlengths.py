...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conf.theme'
        db.alter_column('projects_conf', 'theme', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Project.version'
        db.alter_column('projects_project', 'version', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Conf.theme'
        db.alter_column('projects_conf', 'theme', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Project.version'
        db.alter_column('projects_project', 'version', self.gf('django.db.models.fields.CharField')(max_length=20))
