...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'File.status'
        db.add_column('projects_file', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'File.status'
        db.delete_column('projects_file', 'status')
