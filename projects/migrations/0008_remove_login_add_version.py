...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('projects_project', 'version', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('projects_project', 'version')
