...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Project.github_login'
        db.delete_column('projects_project', 'github_login')

        # Deleting field 'Project.github_repo'
        db.delete_column('projects_project', 'github_repo')

        # Adding field 'Project.repo'
        db.add_column('projects_project', 'repo', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Project.login'
        db.add_column('projects_project', 'login', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'Project.github_login'
        raise RuntimeError(
            "Cannot reverse this migration. 'Project.github_login' and its values cannot be restored.")

        # We cannot add back in field 'Project.github_repo'
        raise RuntimeError(
            "Cannot reverse this migration. 'Project.github_repo' and its values cannot be restored.")

        # Deleting field 'Project.repo'
        db.delete_column('projects_project', 'repo')

        # Deleting field 'Project.login'
        db.delete_column('projects_project', 'login')
