...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FileRevision.created_date'
        db.add_column('projects_filerevision', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 8, 15, 1, 7, 31, 20436), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FileRevision.created_date'
        db.delete_column('projects_filerevision', 'created_date')
