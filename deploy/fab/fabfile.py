...
def install_packages(type):
    ...
    if type == 'build':
        sudo(
            'apt-get install -y git-core python-dev postgresql-client libpq-dev subversion graphviz curl sqlite libxml2-dev libxslt-dev vim g++ python-numpy build-essential texlive-full')
