...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GithubProject.user'
        db.delete_column(u'oauth_githubproject', 'user_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'GithubProject.user'
        raise RuntimeError("Cannot reverse this migration. 'GithubProject.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'GithubProject.user'
        db.add_column(u'oauth_githubproject', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='github_projects', to=orm['auth.User']),
                      keep_default=False)
