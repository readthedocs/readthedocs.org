    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_url', models.URLField(blank=True, null=True, verbose_name='Avatar image URL')),
                ('url', models.URLField(blank=True, null=True, verbose_name='URL to organization page')),
        ...
        migrations.AddField(
            ...
            name='users',
            field=models.ManyToManyField(related_name='oauth_organizations', through='oauth.RemoteOrganizationRelation', to=settings.AUTH_USER_MODEL, verbose_name='Users'),
        ),
