...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_project', 'repo', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Project.repo'
        db.alter_column(u'projects_project', 'repo', self.gf('django.db.models.fields.CharField')(max_length=100))
