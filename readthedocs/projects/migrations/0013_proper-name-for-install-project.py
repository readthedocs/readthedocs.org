...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(default=None, max_length=255, blank=True, help_text='A <a href="https://pip.pypa.io/en/latest/user_guide.html#requirements-files">pip requirements file</a> or <a href="http://conda.pydata.org/docs/using/envs.html#export-the-environment-file">Conda Environment File</a> needed to build your documentation. Path from the root of your project.', null=True, verbose_name='Requirements file'),
        ),
        migrations.AlterField(
            model_name='project',
            name='single_version',
