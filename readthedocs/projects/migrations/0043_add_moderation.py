...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.comment_moderation'
        db.add_column(u'projects_project', 'comment_moderation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.comment_moderation'
        db.delete_column(u'projects_project', 'comment_moderation')
