...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.setup_dir'
        db.add_column(u'projects_project', 'setup_dir',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.setup_dir'
        db.delete_column(u'projects_project', 'setup_dir')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'setup_dir': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
