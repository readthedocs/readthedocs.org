    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_major', models.IntegerField(default=2, max_length=3, blank=True, help_text='2 means supporting 3.X.X and 2.X.X, but not 1.X.X', null=True, verbose_name='Number of Major versions')),
                ('num_minor', models.IntegerField(default=2, max_length=3, blank=True, help_text='2 means supporting 2.2.X and 2.1.X, but not 2.0.X', null=True, verbose_name='Number of Minor versions')),
                ('num_point', models.IntegerField(default=2, max_length=3, blank=True, help_text='2 means supporting 2.2.2 and 2.2.1, but not 2.2.0', null=True, verbose_name='Number of Point versions')),
