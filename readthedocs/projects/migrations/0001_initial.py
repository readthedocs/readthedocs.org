    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        blank=True,
                        help_text='Requires Virtualenv. A <a href="https://pip.pypa.io/en/latest/user_guide.html#requirements-files">pip requirements file</a> needed to build your documentation. Path from the root of your project.',
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        default=b"python",
                        help_text="(Beta) The Python interpreter used to create the virtual environment.",
                        max_length=20,
                        verbose_name="Python Interpreter",
                        choices=[
                            (b"python", "CPython 2.x"),
                            (b"python3", "CPython 3.x"),
                        ],
                    ),
                ),
                (
                ...
                (
                    "django_packages_url",
                    models.CharField(
                        max_length=255, verbose_name="Django Packages URL", blank=True
                    ),
                ),
                (
                    "privacy_level",
                    models.CharField(
                        default=b"public",
                        help_text="(Beta) Level of privacy that you want on the repository. Protected means public but not in listings.",
                        max_length=20,
                ...
                (
                    ...
                    models.CharField(
                        default=b"public",
                        help_text="(Beta) Default level of privacy you want on built versions of documentation.",
                        max_length=20,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (b"fo", b"Faroese"),
                            (b"fr", b"French"),
                            (b"fy", b"Western Frisian"),
                            (b"ga", b"Irish"),
                            (b"gd", b"Scottish Gaelic"),
                            (b"gl", b"Galician"),
                            (b"gn", b"Guarani"),
                            (b"gu", b"Gujarati"),
                            (b"ha", b"Hausa"),
                            ...
                            (b"zh", b"Chinese"),
                            (b"zu", b"Zulu"),
                            (b"nb_NO", b"Norwegian Bokmal"),
                            (b"pt_BR", b"Brazilian Portuguese"),
                            (b"es_MX", b"Mexican Spanish"),
                            (b"uk_UA", b"Ukrainian"),
                ...
                (
                    ...
                    models.IntegerField(
                        default=2,
                        blank=True,
                        help_text="2 means supporting 3.X.X and 2.X.X, but not 1.X.X",
                        null=True,
                        verbose_name="Number of Major versions",
                    ),
                ),
                (
                    "num_minor",
                    models.IntegerField(
                        default=2,
                        blank=True,
                        help_text="2 means supporting 2.2.X and 2.1.X, but not 2.0.X",
                        null=True,
                        verbose_name="Number of Minor versions",
                    ),
                ),
                (
                    "num_point",
                    models.IntegerField(
                        default=2,
                        blank=True,
                        help_text="2 means supporting 2.2.2 and 2.2.1, but not 2.2.0",
                        null=True,
                        verbose_name="Number of Point versions",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(help_text="URL to send the webhook to", blank=True),
                ),
                (
                    "project",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="projects.ProjectRelationship",
                blank=True,
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="emailhook_notifications",
                to="projects.Project",
                on_delete=models.CASCADE,
            ),
        ),
