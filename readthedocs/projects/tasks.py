...
def update_imported_docs(project, version):
    ...
    if project.use_virtualenv:
        ...
        update_docs_output['sphinx'] = run('{cmd} install -U hg+http://bitbucket.org/birkenfeld/sphinx/@d4c6ac1fcc9c#egg=Sphinx 2virtualenv==1.8.2 distribute==0.6.28 docutils==0.8.1'.format(
