...
class SyncRepositoryMixin:
    ...
    def sync_versions(self, version_repo):
        ...
        if version_repo.supports_tags and self.project.has_feature(Feature.SYNC_TAGS):
            version_post_data['tags'] = [{
                'identifier': v.identifier,
                'verbose_name': v.verbose_name,
            } for v in version_repo.tags]

        if version_repo.supports_branches and self.project.has_feature(Feature.SYNC_BRANCHES):
