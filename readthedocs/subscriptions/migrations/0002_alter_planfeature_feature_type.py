...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='feature_type',
            field=models.CharField(choices=[('cname', 'Custom domain'), ('cdn', 'CDN public documentation'), ('ssl', 'Custom SSL configuration'), ('support', 'Support SLA'), ('private_docs', 'Private documentation'), ('embed_api', 'Embed content via API'), ('search_analytics', 'Search analytics'), ('pageviews_analytics', 'Pageview analytics'), ('concurrent_builds', 'Concurrent builds'), ('sso', 'Single sign on (SSO) with Google'), ('urls', 'Custom URLs'), ('audit-logs', 'Audit logs'), ('audit-pageviews', 'Audit logs for every page view')], max_length=32, verbose_name='Type'),
        ),
    ]
