    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stripe_id",
                    models.CharField(max_length=100, verbose_name="Stripe ID"),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="<b>Warning</b>: This will make this subscription available for users to buy. Don't add unless you're sure.",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        verbose_name="For organizations",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Locked plan for custom contracts",
                        verbose_name="Locked plan",
                    ),
                ),
                (
                    "modified_date",
                ...
                (
                    "status",
                    models.CharField(max_length=16, verbose_name="Subscription status"),
                ),
                (
                    "start_date",
                    models.DateTimeField(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("audit-pageviews", "Record every page view"),
                        ],
                        max_length=32,
                        verbose_name="Type",
                    ),
