    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exit_code', models.IntegerField(max_length=3, null=True, verbose_name='Exit code', blank=True)),
                ('commit', models.CharField(max_length=255, null=True, verbose_name='Commit', blank=True)),
                ('length', models.IntegerField(max_length=10, null=True, verbose_name='Build Length', blank=True)),
