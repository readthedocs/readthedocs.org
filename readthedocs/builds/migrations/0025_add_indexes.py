...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Build', fields ['version', 'state', 'type']
        db.create_index(u'builds_build', ['version_id', 'state', 'type'])


    def backwards(self, orm):
        # Removing index on 'Build', fields ['version', 'state', 'type']
        db.delete_index(u'builds_build', ['version_id', 'state', 'type'])
    ...
    models = {
        ...
        u'builds.build': {
            'Meta': {'ordering': "['-date']", 'object_name': 'Build', 'index_together': "[['version', 'state', 'type']]"},
