...
class TestPostBuildOverview(TestCase):
    ...
    def test_post_build_overview_build_failed(self, now, post_comment):
        ...
        expected_comment = dedent(
            f"""
            ❌ **Documentation build failed** — no preview for this commit.

            ---
            [My project build overview](https://readthedocs.org/projects/my-project/builds/{failed_build.id}/) · last updated 17 Sep 2026, 08:53 UTC
            """
        )
