...
def make_test_git():
    ...
    # the repo
    log.info(check_output(
        ['git', 'checkout', '-b', 'submodule', 'master'], env=env))
    ...
    log.info(check_output(['git', 'checkout', '-b',
                           'relativesubmodule', 'master'], env=env))
    log.info(check_output(
    ...
    log.info(check_output(['git', 'add', '.'], env=env))
    log.info(check_output(
        ['git', 'commit', '-m"Add relative submodule"'], env=env))
    ...
    log.info(check_output(['git', 'add', '.'], env=env))
    log.info(check_output(
        ['git', 'commit', '-m"Add invalid submodule"'], env=env))
