...
class TestRepoParsing(TestCase):
    ...
    def test_github(self):
        ...
        self.assertEqual(
            self.version.get_github_url(docroot="/docs/", filename="file"),
            "https://github.com/user/repo/blob/master/docs/file.rst",
        )
    ...
    def test_gitlab(self):
        ...
        self.assertEqual(
            self.version.get_gitlab_url(docroot="/foo/bar/", filename="file"),
    ...
    def test_bitbucket(self):
        ...
        self.assertEqual(
            self.version.get_bitbucket_url(docroot="/foo/bar/", filename="file"),
