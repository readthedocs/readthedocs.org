...
class TestRepoParsing(TestCase):
    ...
    def test_github(self):
        ...
        self.assertEqual(self.version.get_github_url(
            docroot='/docs/', filename='file'), 'https://github.com/user/repo/blob/master/docs/file.rst')
        ...
        self.assertEqual(self.version.get_github_url(docroot='/docs/', filename='file'),
                         'https://github.com/user/repo.github.io/blob/master/docs/file.rst')
        ...
        self.assertEqual(self.version.get_github_url(docroot='/docs/', filename='file'),
                         'https://github.com/user/repo.git/blob/master/docs/file.rst')
    ...
    def test_gitlab(self):
        ...
        self.assertEqual(self.version.get_gitlab_url(docroot='/foo/bar/', filename='file'),
                         'https://gitlab.com/user/repo/blob/master/foo/bar/file.rst')
        ...
        self.assertEqual(self.version.get_gitlab_url(docroot='/foo/bar/', filename='file'),
                         'https://gitlab.com/user/repo.gitlab.io/blob/master/foo/bar/file.rst')
        ...
        self.assertEqual(self.version.get_gitlab_url(docroot='/foo/bar/', filename='file'),
                         'https://gitlab.com/user/repo.git/blob/master/foo/bar/file.rst')
    ...
    def test_bitbucket(self):
        ...
        self.assertEqual(self.version.get_bitbucket_url(docroot='/foo/bar/', filename='file'),
                         'https://bitbucket.org/user/repo/src/master/foo/bar/file.rst')
        ...
        self.assertEqual(self.version.get_bitbucket_url(docroot='/foo/bar/', filename='file'),
                         'https://bitbucket.org/user/repo.gitbucket.io/src/master/foo/bar/file.rst')
        ...
        self.assertEqual(self.version.get_bitbucket_url(docroot='/foo/bar/', filename='file'),
                         'https://bitbucket.org/user/repo.git/src/master/foo/bar/file.rst')
