...
urlpatterns = [
    ...
    url(r'^advertising/$', TemplateView.as_view(template_name='donate/advertising.html'), name='advertising'),
    url(r'^advertising-submitted/$', TemplateView.as_view(template_name='donate/advertising-submitted.html'), name='advertising-submitted'),
