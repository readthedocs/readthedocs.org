...
def serve_error_404(request, template_name='404.html'):
    """
    ...
    # Remove the ``/404`` part of the beginning of the URL to get the real path
    full_path = full_path.replace('/404/', '/', 1)
