...
class TestCustomURLPatterns(BaseDocServing):
    ...
    def test_custom_urlpattern_multi_version_project(self):
        ...
        resp = self.client.get("/custom/prefix/en/latest/api/index.html", HTTP_HOST=host)
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(
            resp['x-accel-redirect'], '/proxito/media/html/project/latest/api/index.html',
        )
    ...
    def test_custom_urlpattern_multi_version_project_translation(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(
            resp['x-accel-redirect'], '/proxito/media/html/translation/latest/index.html',
        )

        resp = self.client.get("/custom/prefix/es/latest/api/index.html", HTTP_HOST=host)
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(
            resp['x-accel-redirect'], '/proxito/media/html/translation/latest/api/index.html',
        )
    ...
    def test_custom_urlpattern_subproject(self):
        ...
        self.assertEqual(resp.status_code, 302)
        self.assertEqual(resp['Location'], "http://project.readthedocs.io/custom/subproject/prefix/")

        resp = self.client.get("/en/latest/", HTTP_HOST="subproject.readthedocs.io")
        self.assertEqual(resp.status_code, 302)
        self.assertEqual(resp['Location'], "http://project.readthedocs.io/custom/subproject/prefix/en/latest/")
        ...
        resp = self.client.get("/custom/subproject/prefix/en/latest/api/index.html", HTTP_HOST=host)
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(
    ...
    def test_custom_urlpattern_and_urlpattern_subproject_with_translations(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(
            resp['x-accel-redirect'], '/proxito/media/html/subproject-translation/latest/index.html',
        )
