...
class ProxitoHeaderTests(BaseDocServing):
    ...
    def test_serve_headers(self):
        r = self.client.get('/en/latest/', secure=True, HTTP_HOST='project.dev.readthedocs.io')
    ...
    def test_subproject_serve_headers(self):
        r = self.client.get('/projects/subproject/en/latest/', secure=True, HTTP_HOST='project.dev.readthedocs.io')
        self.assertEqual(r.status_code, 200)
    ...
    def test_404_headers(self):
        r = self.client.get('/foo/bar.html', secure=True, HTTP_HOST='project.dev.readthedocs.io')
