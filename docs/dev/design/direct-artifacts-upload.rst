...
This should mainly happen when using both systems at the same time (keep building on Read the Docs, and upload artifacts from their CI for some branches),
...
POST /api/v3/upload/initiate:
  ...
  .. code-block:: json

     {
        ...
        // this isn't needed. But maybe still require it to be explicit?
        "project": "slug",
        "version": {
