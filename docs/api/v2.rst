...
.. tip::
    ...
    This API is in need of simplifying for end users.
...
.. http:get::  /api/v2/search/project/?q={query}
    ...
    Results are returned in order of the best match.
    ...
    :>json array results: An array of matching results
...
.. http:get::  /api/v2/project/{id}/active_versions/
