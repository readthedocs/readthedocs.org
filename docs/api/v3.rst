   ...
   .. tabs::
     ...
     .. tab:: Read the Docs for Business
         ...
         .. tip::
            ...
            You will find your access Token under
            `your profile settings <https://readthedocs.com/accounts/tokens/>`_.
...
.. http:get:: /api/v3/projects/
   ...
   .. note::
      ...
      :query string expand: with ``organization`` and ``teams``.
...
.. http:post:: /api/v3/projects/
   ...
   .. note::
      ...
      :>json string organization: required organization's slug under the project will be imported.
      :>json string teams: optional teams' slugs the project will belong to.
