...
.. http:get:: /api/v3/projects/
    ...
    **Example response**:
    ...
    The ``results`` in response is an array of project data, which is same to the `Project API <https://docs.readthedocs.io/en/stable/api/v3.html#get--api-v3-projects-(string-project_slug)->`_.
