...
.. warning::
   ...
   Version 1 is deprecated and :doc:`support is removed in September 2023 <rtd-blog:migrate-configuration-v2>`.
   Instead, use the version 2 of the configuration file.
