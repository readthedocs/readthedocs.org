...
.. note::
   ...
   dashboard. All paths in the configuration file are always relative to the
   **repository root**, not the location of the configuration file.
   See the :doc:`/guides/setup/monorepo` documentation for more details.
...
.. warning::
   ...
   However, you can use :ref:`build-customization:where to put files` with custom build commands to generate offline formats for any documentation framework.
