    ...
    **Example response**:
...

        {
            ...
            "results": [{
                ...
                "_links": {
                    ...
                    "sharing": "/api/v3/projects/pip/sharing/",
    ...
    .. note::
      ...
      :Query Parameters:
         ...
         * **_links.sharing** (*string*) -- Link to manage sharing methods (secret link, password, and HTTP header token).
           ...
           "results": [
               {
                   "_links": {
                       ...
                       "sharing": "https://app.readthedocs.com/api/v3/projects/pypa-pip/sharing/",
