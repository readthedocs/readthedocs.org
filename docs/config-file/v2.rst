...
.. note::
   ...
   Make sure to use quotes (``"``) around the value,
   or YAML will take your value as a number
   (``3.10`` will be transformed to ``3.1``).
   Using numbers is valid, but not recomended.
